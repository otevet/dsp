...
Bayesian Theorem can be used to solve this problem.
P(I|K) = P(K|I)(PI)/PK = P(K|I)(PI)/P(K|I)P(I)+P(K|E)P(E)
let K= twin brothers, I = identical twins, and E = fraternal twins
It was given that P(I) = (1/300) and P(E) = (1/125)
Also, P(K|I), the probability that a pair of twins will be male, assuming that they are identical twins is (1/2). The probability P(K|E) that given fraternal twins, they will be male, is (1/2)* (1/2) = (1/4)
Plugging in: (1/2)(1/300)/(1/2)(1/300)+(1/4)(1/125) = 5/11
...
>> In frequentist statistics, probability only has meaning in terms of a limiting case of repeated measurements, and probabilities are fundamentally related to frequencies of events.
In Bayesian statistics, the concept of probability is extended to cover degrees of certainty about statements and probabilities are fundamentally related to our own knowledge about an event.
